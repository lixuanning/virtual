export default {
  ...
  form: {
    ...
    bootRefresh:'Boot refresh',
    prohibitMatching:'Prohibit matching',
    allowMatching:'Allow matching',
    changeToAgent:'Change To Agent',
    whetherToMatch:'Whether to match',
    changeToMerchant:'Change To Merchant',
