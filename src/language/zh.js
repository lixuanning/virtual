...
export default {
  ...
  form: {
    ...
    bootRefresh:'启动刷新',
    changeToAgent:'改为代理商',
    prohibitMatching:'禁止匹配',
    whetherToMatch:'是否可以匹配',
    allowMatching:'允许匹配',
    changeToMerchant:'改为商户',
    expirationDate: "有效期",
    withdrawPayee: "收款人",
    ...
    confirmDelete: "确定删除？",
    confirmRecharge: "确定操作？",
    confirm: "确定",
    putaway: "上架",
    takeaway: "下架",
    supportLegalCurrencyArr: "支持法币",
    success: "成功！",
    amount: "数量",
    apaSetting: "API 设置",
    ...
    merchantEmailantId: "商户邮箱",
    no: "否",
    cardld: "卡号",
    countDataCurrentDayForServiceCharge: "当天手续费",
    countDataCurrentWeekForServiceCharge: "当周手续费",
    countDataCurrentDayForProxy: "当天代理费",
    countDataCurrentWeekForProxy: "当周代理费",
    running: "查看流水",
    userDetails: "用户详情",
    weekForInOrder: "当周入金",
    dayForOutOrder: "当天出金",
    qrCodePicture: "二维码",
    weekForOutOrder: "当周出金",
    payAccount: "支付账号",
