    ...
    <el-row :gutter="20">
      ...
      <el-col :span="8">
        <el-card class="stat-card">
          ...
          <div class="card-content">{{ data.merchantFreezeBalance }}</div>
        </el-card>
      </el-col>
    </el-row>
...
import { queryMerchantDashboard } from "@/api/buyer";
...
const getData = async () => {
  const response = await queryMerchantDashboard();
